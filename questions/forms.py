...
class privatequizquestions(forms.Form):
    ...
    promt2 = forms.CharField(max_length=255)
    ...
    promt3 = forms.CharField(max_length=255)
    ...
    promt4 = forms.CharField(max_length=255)
    ...
    promt5 = forms.CharField(max_length=255)
    ...
    promt6 = forms.CharField(max_length=255)
    ...
    promt7 = forms.CharField(max_length=255)
    ...
    promt8 = forms.CharField(max_length=255)
    ...
    promt9 = forms.CharField(max_length=255)
    ...
    promt10 = forms.CharField(max_length=255)
